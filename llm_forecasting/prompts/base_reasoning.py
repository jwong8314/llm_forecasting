...
BINARY_SCRATCH_PAD_PROMPT_QUANT_50_1 = (
    """Question:
{question}
...
6. Output your prediction (an 50 percent confidence in the format [lowerbound, upperbound]) with an asterisk at the beginning and end of the confidence interval (e.g. '*[1.8,5.3]*').
Ensure the bounds are expressed as floating point numbers. If it's a time-based question, follow the original question to determine if it's in minutes, hours, days, etc.
{{ Insert your answer }}""",
    ("QUESTION", "BACKGROUND", "RESOLUTION_CRITERIA", "DATES", "RETRIEVED_INFO"),
)
...
BINARY_SCRATCH_PAD_PROMPT_QUANT_50_2 = (
    """Question:
{question}
...
Aggregating considerations: {{ Aggregate your considerations }}
Ensure the bounds are expressed as floating point numbers. If it's a time-based question, follow the original question to determine if it's in minutes, hours, days, etc.
Answer: {{ Output your prediction (an 50 percent confidence in the floating point format [lowerbound, upperbound]) with an asterisk at the beginning and end of the confidence interval (e.g. '*[1.8,5.3]*') }}""",
    ("QUESTION", "BACKGROUND", "RESOLUTION_CRITERIA", "DATES", "RETRIEVED_INFO"),
)



BINARY_SCRATCH_PAD_PROMPT_QUANT_50_3 = (
    """Question: {question}
...
7. Output your final 50 percent confidence interval ( in the format [lowerbound, upperbound]) with an asterisk at the beginning and end of the confidence interval (e.g. '*[1.8,5.3]*')
Ensure the bounds are expressed as floating point numbers. If it's a time-based question, follow the original question to determine if it's in minutes, hours, days, etc.
{{ Insert your answer }}""",
    ("QUESTION", "BACKGROUND", "RESOLUTION_CRITERIA", "DATES", "RETRIEVED_INFO"),
)

BINARY_SCRATCH_PAD_PROMPT_QUANT_50_6 = (
    """Question:
{question}
