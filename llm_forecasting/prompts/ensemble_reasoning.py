...
4. Output your prediction (an 50 percent confidence in the format [lowerbound, upperbound]) with an asterisk at the beginning and end of the confidence interval (e.g. '*[1.8,5.3]*').
{{ Insert the confidence interval here }}""",
    (
        "QUESTION",
        "BACKGROUND",
